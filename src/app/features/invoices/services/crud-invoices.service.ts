...
export class CrudInvoicesService {
  private endpoint = 'invoice-header';
  ...
  getTopProducts(): Observable<any> {
    return this.httpService.get<any>(`${this.endpoint}/getTopProducts`);
  }

  getTopServices(): Observable<any> {
    return this.httpService.get<any>(`${this.endpoint}/getTopServices`);
  }
}
